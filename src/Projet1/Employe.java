...
abstract class Employe {
	...
	private int age;
	private String date;
	public final static int salarybase=110000;
...
class Vendeur extends Commercial {
	...
	public double calculerSalaire() {
		return (salarybase + POURCENT_VENDEUR * getChiffreAffaire()) + BONUS_VENDEUR;
	}
...
class Technicien extends Employe {
	...
	public double calculerSalaire() {
		return (salarybase + FACTEUR_UNITE * unites);
	}
...
class Manutentionnaire extends Employe {
	...
	public double calculerSalaire() {
		return (salarybase + SALAIRE_HORAIRE * heures);
	}
...
class Personnel {
	...
	private final static int MAXEMPLOYE = 2000;
